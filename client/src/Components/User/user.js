...
const User = () => {
  ...
  const fetchUsers = async () => {
    try {
      ...
      const response = await fetch('https://newquiz-41r7.onrender.com/api/authh/getAllUsers', {
        method: "GET",
        headers: {
  ...
  const deleteUser = async (id) => {
    try {
      const token = TokenFROMLSGet();
      const response = await fetch(`https://newquiz-41r7.onrender.com/api/authh/delete/${id}`, {
        method: 'DELETE',
        headers: {
  ...
  const updateUser = async () => {
    try {
      const token = TokenFROMLSGet();
      const response = await fetch(`https://newquiz-41r7.onrender.com/api/authh/update/${selectedUser._id}`, {
        method: 'PATCH',
        headers: {
